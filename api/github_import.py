...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        try:
            ...
            repo_metadata = self._extract_repo_metadata(clone_dir, repo_url)
            ...
            response_data = {
                ...
                "analysis_summary": {
                    ...
                    "languages_detected": self._detect_languages(dep_graph),
    ...
    def _extract_repo_metadata(self, clone_dir: str, repo_url: str) -> dict:
    ...
    def _detect_languages(self, dep_graph: dict) -> list:
