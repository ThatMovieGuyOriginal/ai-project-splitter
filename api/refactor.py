...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            plan = self._generate_enhanced_refactor_plan(clusters, tempdir, complexity_scores, debt_analysis)
            ...
            if not accept_changes:
                ...
                response_data = {
                    ...
                    "analysis_summary": {
                        ...
                        "refactor_impact": self._calculate_refactor_impact(plan, complexity_scores)
                    },
                    "recommendations": self._generate_refactor_recommendations(clusters, complexity_scores, debt_analysis),
            ...
            try:
                ...
                self._perform_enhanced_refactor(clusters, tempdir, complexity_scores)
                ...
                self.send_header('Content-Disposition', 'attachment; filename="refactored_enhanced.zip"')
                self.send_header('Access-Control-Allow-Origin', '*')
                self.send_header('X-Enhancement-Status', 'refactor_complete')
                self.end_headers()
    ...
    def _generate_enhanced_refactor_plan(self, clusters, root_dir, complexity_scores, debt_analysis):
    ...
    def _analyze_complexity_distribution(self, complexity_scores):
    ...
    def _calculate_refactor_impact(self, plan, complexity_scores):
    ...
    def _generate_refactor_recommendations(self, clusters, complexity_scores, debt_analysis):
    ...
    def _perform_enhanced_refactor(self, clusters, root_dir, complexity_scores):
